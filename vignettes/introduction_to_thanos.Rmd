...
mags_sequences_files <- mags_sequences_files[sample(length(mags_sequences_files), 50)]
...
```{r contigs-workflow-prep}

contigs_depths_files <- list.files("../inst/extdata/contigs_example/depths/", full.names = T)[1:2]
contigs_sequences_files <- list.files("../inst/extdata/contigs_example/protein_sequences", full.names = T)[1:2]
control_afa <- "../inst/extdata/controls/bac120_r214_reps_PF01025.20.afa"
...
And we can of course visualise the results.
